...
public class ClassroomController {
    ...
    @GetMapping(Endpoint.V1.Classroom.GET_CLASS_BY_ID)
    ...
    @GetMapping(Endpoint.V1.Classroom.GET_MY_CLASS)
    public ResponseEntity<GlobalResponse<Meta, List<GetClassroomResponse>>> getMyClassroom(@AuthenticationPrincipal UserDetails userDetails){
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(classroomService.getMyClassrooms(userDetails.getUsername()));
    }
}
